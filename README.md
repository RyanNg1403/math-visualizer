...
| Path | What it is |
|---|---|
| `index.html` | **The Derivative** — interactive HTML slide deck. Open it in a browser; step through with `→` (each press plays one animation beat, Manim-style), `←` back, `r` replay. Sliders and draggable points on several slides. |
